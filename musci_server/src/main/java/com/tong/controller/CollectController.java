...
public class CollectController {
    ...
    private Object addCollect(HttpServletRequest request){
     ...
     * 删除收藏 根据用户id和歌曲id
     */
    @RequestMapping(value = "/deleteBySongIdUserId",method = RequestMethod.GET)
    public Object deleteBySongIdUserId(HttpServletRequest request){
        JSONObject jsonObject = new JSONObject();
        String userId = request.getParameter("userId");           //用户id

        String songId = request.getParameter("songId");           //歌曲id
        boolean flag = collectService.deleteBySongIdUserId(Integer.parseInt(userId),Integer.parseInt(songId));
        return flag;
    }
